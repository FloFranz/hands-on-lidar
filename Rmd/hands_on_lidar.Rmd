...
### Generierung eines Vegetationshöhenmodells
...
chm <- lidR::rasterize_canopy(nlas_new, res = 1, algorithm = p2r())
...
chm <- lidR::rasterize_canopy(nlas_new, res = 0.5, algorithm = p2r())
plot(chm, col = height.colors(25))
```
...
chm <- lidR::rasterize_canopy(nlas_new, res = 0.5, p2r(0.2, na.fill = tin()))
plot(chm, col = height.colors(25))
```
...
chm <- lidR::rasterize_canopy(nlas_new, res = 0.5, algorithm = dsmtin())
plot(chm, col = height.colors(25))
```
...
chm <- lidR::rasterize_canopy(nlas_new, res = 0.5, algorithm = dsmtin(max_edge = 8))
plot(chm, col = height.colors(25))
```
